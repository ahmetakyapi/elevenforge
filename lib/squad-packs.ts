...
const BESIKTAS = pack(
  ...
  [
    ...
    { n: "Tayyip Talha Sanuç",   pos: "DEF", role: "CB",  num: 24, age: 25, ovr: 73, pot: 78, nat: "TR" },
    ...
    { n: "Tayfur Bingöl",        pos: "DEF", role: "RB",  num: 75, age: 32, ovr: 72, pot: 72, nat: "TR" },
...
const TRABZONSPOR = pack(
  ...
  [
    ...
    { n: "Onuralp Çevikkan",     pos: "GK",  role: "GK",  num: 20, age: 25, ovr: 73, pot: 77, nat: "TR" },
    // DEF
...
const KONYASPOR = pack(
  ...
  [
    ...
    { n: "Adamo Nagalo",         pos: "DEF", role: "CB",  num: 39, age: 23, ovr: 74, pot: 80, nat: "BF" },
...
const ALANYASPOR = pack(
  ...
  [
    ...
    { n: "Batuhan Yavuz",        pos: "DEF", role: "RB",  num: 2,  age: 26, ovr: 73, pot: 76, nat: "TR" },
...
const KASIMPASA = pack(
  ...
  [
    ...
    { n: "Andri Baldursson",     pos: "MID", role: "CM",  num: 16, age: 23, ovr: 74, pot: 79, nat: "IS" },
...
const EYUPSPOR = pack(
  ...
  [
    ...
    { n: "Lenny Pintor",         pos: "FWD", role: "LW",  num: 23, age: 25, ovr: 74, pot: 78, nat: "FR" },
...
const RIZESPOR = pack(
  ...
  [
    ...
    { n: "Valentin Mihăilă",     pos: "FWD", role: "RW",  num: 7,  age: 26, ovr: 77, pot: 79, nat: "RO" },
...
const KOCAELISPOR = pack(
  ...
  [
    ...
    { n: "Anfernee Dijksteel",   pos: "DEF", role: "CB",  num: 2,  age: 29, ovr: 75, pot: 75, nat: "SR" },
